            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-12" style="display: flex; justify-content: space-between;align-items: center;margin-bottom: 50px;">
                  ...
                  <a href="/app/facture/ajouter" class="btn btn-primary rounded-pill" style="width: 100px;" >Ajouter</a>
                </div>      
                    ...
                    <tbody>
                      <c:forEach items="${liste}" var="p">
                        <tr>
                          ...
                          <td>
                            <a href="#" class="sidebar-item"><i class="bi bi-eye" style="font-size: 20px; margin-right: 6px; color: rgb(3, 123, 252);"></i></a>
