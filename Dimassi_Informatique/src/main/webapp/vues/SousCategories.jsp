            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-12" style="display: flex; justify-content: space-between;align-items: center;margin-bottom: 50px;">
                  ...
                  <a href="/app/sousCategorie/ajouter" class="btn btn-primary rounded-pill" style="width: 100px;" >Ajouter</a>
                </div>      
                      ...
                      <c:forEach items="${liste}" var="p">
                        <tr >
                          ...
                          <td>
                            ...
                            <a href="/app/sousCategorie/modifier/${p.id}"><i class="bi bi-gear" style="font-size: 20px; margin-right: 6px;color: rgb(0, 227, 91);"></i></a>
                            <a href="/app/sousCategorie/supprimer/${p.id}" class="sidebar-item"><i class="bi bi-trash" style="font-size: 20px; margin-right: 6px; color: red;"></i></a>
                          </td>
                        </tr>
                      </c:forEach>               
                    </tbody>
