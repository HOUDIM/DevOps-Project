            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-12" style="display: flex; justify-content: space-between;align-items: center;margin-bottom: 50px;">
                  ...
                  <a href="/app/commentaire/ajouter" class="btn btn-primary rounded-pill" style="width: 100px;" >Ajouter</a>
                </div>      
                  ...
                  <table class="table table-striped mb-0">
                    ...
                    <tbody>
                      <c:forEach items="${liste}" var="p">
                        <tr >
                          <td class="text-bold-500"><img src="/../Images/${p.visiteur.photo}" alt="Logo" srcset=""
                            style="width: 75px;height: 75px;border-radius: 15%;" /></td>
                          <td>${p.visiteur.prenom} ${p.visiteur.nom}</td>
                          <td>${p.date}</td>
                          <td>${p.texte}</td>
                          <td>
                            <a href="/app/commentaire/modifier/${p.id}"><i class="bi bi-gear" style="font-size: 20px; margin-right: 6px;color: rgb(0, 227, 91);"></i></a>
                            <a href="/app/commentaire/supprimer/${p.id}" class="sidebar-item"><i class="bi bi-trash" style="font-size: 20px; margin-right: 6px; color: red;"></i></a>
                          </td>
                        </tr>
                      </c:forEach>               
                    </tbody>
